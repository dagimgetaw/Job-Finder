...
export default function Saved({ jobs, handleBookMark, bookmarkedJobs }) {
  ...
  return (
    <div className="shadow-lg border border-gray-300 rounded-xl p-6 bg-white flex flex-col w-sm h-120 gap-4">
      ...
      {savedJobs.length < 1 ? (
        ...
        savedJobs.map((job) => (
          <div
            key={job.id}
            className="border border-gray-300 rounded-lg p-4 bg-gray-50 flex flex-col gap-3"
          >
